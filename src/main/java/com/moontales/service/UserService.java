package com.moontales.service;

import com.moontales.model.Role;
import com.moontales.model.User;
import com.moontales.repository.RoleRepository;
import com.moontales.repository.UserRepository;
...
public class UserService {
    ...
    public User registerWithEmail(String username, String email, String rawPassword) {
        ...
        Role r = roleRepository.findByRoleName("user").orElse(null);
        user.setRole(r);
